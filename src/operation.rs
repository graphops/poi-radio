...
use crate::{
    attestation::{
        ...
        log_comparison_summary, log_gossip_summary, process_messages, save_local_attestation,
        Attestation, ComparisonResult,
    },
    chainhead_block_str,
...
pub async fn gossip_poi(
    ...
    log_gossip_summary(blocks_str, identifiers.len(), send_ops).await;
}
